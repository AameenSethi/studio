...
export function ModeToggle() {
  ...
  return (
    <Button variant="outline" size="icon" onClick={toggleTheme} className="relative overflow-hidden">
      ...
      <Moon className="absolute h-[1.2rem] w-[1.2rem] transform text-slate-500 opacity-0 transition-all duration-500 ease-in-out dark:translate-y-0 dark:opacity-100" style={{ transform: 'translateY(2rem)' }} />
